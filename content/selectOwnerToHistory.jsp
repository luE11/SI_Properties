...
<head>
    ...
    <title>SI Properties | Propietario - historial de pago</title>
    ...
    <div class="columns">
        <div class="column is-4 is-offset-4">
            <div class="container has-text-centered my-5">
                <h1 class="title is-1">Seleccione un propietario para continuar</h1>
            </div>
            <form class="form">
                <div class="field is-flex pt-5">
                    <label class="label">Seleccione un propietario</label>
